...
def upgrade():
    ...
    sa.Column('locked', sa.Boolean, nullable=False, server_default=sa.sql.False_()),
    sa.Column('feedback_required', sa.Boolean, nullable=False, server_default=sa.sql.False_()),
    sa.Column('remote', sa.Boolean, nullable=False, server_default=sa.sql.False_()),
    sa.Column('issuer', sa.String(length=256), nullable=True),
    sa.Column('storage_encryption', sa.Boolean, nullable=False, server_default=sa.sql.False_()),
